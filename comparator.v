...
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w C:/Xilinx/10.1/ISE/ISEexamples/lab3/comparator.sch comparator.vf
...
module comparator(a, 
   ...
   OR2B1 XLXI_14 (.I0(amask[0]), 
                  .I1(XLXN_6), 
                  .O(XLXN_23));
   AND7_MXILINX_comparator XLXI_15 (.I0(XLXN_23), 
                                    .I1(XLXN_22), 
                                    .I2(XLXN_21), 
                                    .I3(XLXN_20), 
                                    .I4(XLXN_19), 
   ...
   COMP8_MXILINX_comparator XLXI_34 (.A(a[15:8]), 
                                     .B(b[15:8]), 
                                     .EQ(XLXN_7));
   // synthesis attribute HU_SET of XLXI_34 is "XLXI_34_7"
endmodule
